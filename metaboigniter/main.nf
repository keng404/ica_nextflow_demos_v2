...
if(params.type_of_ionization in (["pos","both"])){
        ...
        if(params.quantification_openms_xcms_pos == "openms"){
            ...
            */
            process process_openms_to_xcms_conversion_pos_centroided  {
                ...
                """
    Rscript ${workflow.launchDir}/bin/featurexmlToCamera.r \\
                    input=$mzMLFile \\
    ...
    Rscript ${workflow.launchDir}/bin/ipo.r \\
            ...
            process process_masstrace_detection_pos_xcms_centroided {
                ...
                """
    Rscript ${workflow.launchDir}/bin/findPeaks.r \\
                    input=\$PWD/$mzMLFile \\
    ...
    process process_collect_rdata_pos_xcms {
        ...
        """
        nextFlowDIR=\$PWD
    Rscript ${workflow.launchDir}/bin/xcmsCollect.r input=$inputs_aggregated output=collection_pos.rdata
        """
    }
    /*
    ...
    process process_align_peaks_pos_xcms {
        ...
        """
    Rscript ${workflow.launchDir}/bin/retCor.r \\
    ...
    process process_group_peaks_pos_N1_xcms {
        ...
        """
    Rscript ${workflow.launchDir}/bin/group.r \\
            input=$rdata_files \\
    ...
    if(params.blank_filter_pos==true){
        ...
        process process_blank_filter_pos_xcms {
            ...
            """
    Rscript ${workflow.launchDir}/bin/blankfilter.r \\
                input=$rdata_files \\
    ...
    */
    if(params.dilution_filter_pos==true){
        ...
        process process_dilution_filter_pos_xcms {
            ...
            """
    Rscript ${workflow.launchDir}/bin/dilutionfilter.r \\
                input=$rdata_files \\
    ...
    if(params.cv_filter_pos == true){
        ...
        process process_cv_filter_pos_xcms {
            ...
            """
    Rscript ${workflow.launchDir}/bin/cvfilter.r \\
                input=$rdata_files \\
    ...
    process process_annotate_peaks_pos_camera {
        ...
        """
    Rscript ${workflow.launchDir}/bin/xsAnnotate.r input=$rdata_files output=CameraAnnotatePeaks_pos.rdata
        """
    }
    /*
    ...
    process process_group_peaks_pos_camera {
        ...
        """
    Rscript ${workflow.launchDir}/bin/groupFWHM.r \\
            input=$rdata_files \\
    ...
    process process_find_addcuts_pos_camera {
        ...
        """
    Rscript ${workflow.launchDir}/bin/findAdducts.r \\
            input=$rdata_files \\
    ...
    process process_find_isotopes_pos_camera {
        ...
        """
    Rscript ${workflow.launchDir}/bin/findIsotopes.r \\
            input=$rdata_files \\
    ...
    if(params.perform_identification == true){
        ...
        process process_read_MS2_pos_msnbase {
            ...
            """
    Rscript ${workflow.launchDir}/bin/readMS2MSnBase.r \\
                input=$mzMLFile \\
                output=${mzMLFile.baseName}.rdata \\
        ...
        process process_mapmsms_tocamera_pos_msnbase {
            ...
            """
    Rscript ${workflow.launchDir}/bin/mapMS2ToCamera.r \\
        ...
        process process_mapmsms_toparam_pos_msnbase {
            ...
            """
            mkdir out
    Rscript ${workflow.launchDir}/bin/MS2ToMetFrag.r \\
                inputCAMERA=$rdata_files_ms1 \\
    ...
    Rscript ${workflow.launchDir}/bin/fingerID.r \\
                    input=\$PWD/inputs \\
    ...
    Rscript ${workflow.launchDir}/bin/aggregateMetfrag.r \\
    ...
    Rscript ${workflow.launchDir}/bin/metfragPEP.r \\
    ...
    Rscript ${workflow.launchDir}/bin/prepareOutput.r \\
    ...
    Rscript ${workflow.launchDir}/bin/prepareOutput.r \\
        ...
        if(params.perform_identification_metfrag == true){
            ...
            /*
* STEP 22 - do identification using     #!/bin/bash ${workflow.launchDir}/bin/metfrag
             */
            process process_ms2_identification_pos_metfrag {
label     #!/bin/bash ${workflow.launchDir}/bin/metfrag
                //label 'process_high'
                tag "$parameters"
    ...
    bash ${workflow.launchDir}/bin/run_metfrag.sh \\
                        -p {} \\
                        -f \$PWD/outputs/{/.}.csv \\
            ...
            /*
* STEP 23 - aggregate     #!/bin/bash ${workflow.launchDir}/bin/metfrag results
             */
    ...
    Rscript ${workflow.launchDir}/bin/aggregateMetfrag.r \\
            ...
            /*
* STEP 24 - calculate pep from     #!/bin/bash ${workflow.launchDir}/bin/metfrag results
            */
    ...
    Rscript ${workflow.launchDir}/bin/metfragPEP.r \\
            ...
            /*
* STEP 25 - output     #!/bin/bash ${workflow.launchDir}/bin/metfrag results
            */
        ...
        if(params.perform_identification_cfmid == true){
            ...
            */
            process process_ms2_identification_pos_cfmid {
                ...
                find "\$PWD/inputs" -type f | \\
                    parallel \\
-j $params.ncore_pos_cfmid     Rscript ${workflow.launchDir}/bin/cfmid.r \\
                        input={} \\
                        realName={/} \\
    ...
    Rscript ${workflow.launchDir}/bin/findPeaks.r \\
                ...
                process process_annotate_peaks_library_pos_camera {
                    ...
                    """
    Rscript ${workflow.launchDir}/bin/xsAnnotate.r input=$rdata_files output=${rdata_files.baseName}.rdata
                    """
                }
                /*
    ...
    Rscript ${workflow.launchDir}/bin/mapMS2ToCamera.r \\
                ...
                */
                process process_create_library_pos_msnbase {
                    ...
                    """
                    mkdir out
    Rscript ${workflow.launchDir}/bin/createLibrary.r \\
                ...
                process process_collect_library_pos_msnbase {
                    ...
                    """
    Rscript ${workflow.launchDir}/bin/collectLibrary.r \\
                ...
                process process_search_engine_library_pos_msnbase_nolibcharac {
                    ...
                    """
    Rscript ${workflow.launchDir}/bin/librarySearchEngine.r \\
                        -l $libraryFile \\
                        -i $parameters \\
...
if(params.type_of_ionization in (["neg","both"])){
    ...
    process process_collect_rdata_neg_xcms {
        ...
        """
        nextFlowDIR=\$PWD
    Rscript ${workflow.launchDir}/bin/xcmsCollect.r input=$inputs_aggregated output=collection_neg.rdata
        """
    }
    /*
     * STEP 4 - do RT correction
    ...
    */
    ...
    process process_annotate_peaks_neg_camera {
        ...
        """
    Rscript ${workflow.launchDir}/bin/xsAnnotate.r input=$rdata_files output=CameraAnnotatePeaks_neg.rdata
        """
    }
    /*
     * STEP 12 - cgroup the peaks based on their overlap FWHM
...
* STEP 25 - output     #!/bin/bash ${workflow.launchDir}/bin/metfrag results
    ...
    Rscript ${workflow.launchDir}/bin/cfmid.r \\
                        input={} \\
                        realName={/} \\
                        databaseFile=\$PWD/$cfmid_database \\
                        output=\$PWD/outputs/{/.}.csv \\

...
include { AMBER_PROFILING       } from '../subworkflows/local/amber_profiling/main'
include { BAMTOOLS_METRICS      } from '../subworkflows/local/bamtools_metrics/main'
include { CHORD_PREDICTION      } from '../subworkflows/local/chord_prediction/main'
include { COBALT_PROFILING      } from '../subworkflows/local/cobalt_profiling/main'
include { CUPPA_PREDICTION      } from '../subworkflows/local/cuppa_prediction/main'
include { FLAGSTAT_METRICS      } from '../subworkflows/local/flagstat_metrics/main'
include { GRIDSS_SVPREP_CALLING } from '../subworkflows/local/gridss_svprep_calling/main'
include { GRIPSS_FILTERING      } from '../subworkflows/local/gripss_filtering/main'
include { ISOFOX_QUANTIFICATION } from '../subworkflows/local/isofox_quantification/main'
include { LILAC_CALLING         } from '../subworkflows/local/lilac_calling/main'
include { LINX_ANNOTATION       } from '../subworkflows/local/linx_annotation/main'
include { LINX_PLOTTING         } from '../subworkflows/local/linx_plotting/main'
include { ORANGE_REPORTING      } from '../subworkflows/local/orange_reporting/main'
include { PAVE_ANNOTATION       } from '../subworkflows/local/pave_annotation/main'
include { PREPARE_REFERENCE     } from '../subworkflows/local/prepare_reference/main'
include { PURPLE_CALLING        } from '../subworkflows/local/purple_calling/main'
include { READ_ALIGNMENT_DNA    } from '../subworkflows/local/read_alignment_dna/main'
include { READ_ALIGNMENT_RNA    } from '../subworkflows/local/read_alignment_rna/main'
include { READ_PROCESSING       } from '../subworkflows/local/read_processing/main'
include { SAGE_APPEND           } from '../subworkflows/local/sage_append/main'
include { SAGE_CALLING          } from '../subworkflows/local/sage_calling/main'
include { SIGS_FITTING          } from '../subworkflows/local/sigs_fitting/main'
include { VIRUSBREAKEND_CALLING } from '../subworkflows/local/virusbreakend_calling/main'
/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    RUN MAIN WORKFLOW
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
